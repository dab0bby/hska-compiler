...
LanguageParser::LanguageParser()
{
    ...
    vector<State> states;
    /* 00 */ states.add(State(true, Token::IGNORE));
    /* 01 */ states.add(State(false, Token::COLON));
    /* 02 */ states.add(State(false, Token::IGNORE));
    /* 03 */ states.add(State(false, Token::NONE));
    /* 04 */ states.add(State(true, Token::IGNORE));
    /* 05 */ states.add(State(true, Token::ASSIGN));
    /* 06 */ states.add(State(true, Token::PLUS));
    /* 07 */ states.add(State(true, Token::MINUS));
    /* 08 */ states.add(State(true, Token::EQUAL));
    /* 09 */ states.add(State(false, Token::NONE));
    /* 10 */ states.add(State(true, Token::UNKNOWN_BULLSHIT_OPERATOR));
    /* 11 */ states.add(State(false, Token::NONE));
    /* 12 */ states.add(State(true, Token::AND));
    /* 13 */ states.add(State(true, Token::INTEGER));
    /* 14 */ states.add(State(true, Token::IDENTIFIER));
    /* 15 */ states.add(State(true, Token::STAR));
    /* 16 */ states.add(State(true, Token::LESS));
    /* 17 */ states.add(State(true, Token::GREATER));
    /* 18 */ states.add(State(true, Token::NOT));
    /* 19 */ states.add(State(true, Token::SEMICOLON));
    /* 20 */ states.add(State(true, Token::BRACKET_OPEN));
    /* 21 */ states.add(State(true, Token::BRACKET_CLOSE));
    /* 22 */ states.add(State(true, Token::CURLY_BRACKET_OPEN));
    /* 23 */ states.add(State(true, Token::CURLY_BRACKET_CLOSE));
    /* 24 */ states.add(State(true, Token::SQUARE_BRACKET_OPEN));
    /* 25 */ states.add(State(true, Token::SQUARE_BRACKET_CLOSE));
